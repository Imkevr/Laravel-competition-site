                     ...
                     <tr>
                        <td align="left" valign="top">
                           ...
                           <a href="#" target="_blank" style="display: block; max-width: 128px;">
                              <img src="png/cocaColaLogo.png" alt="img" width="128" border="0" style="display: block; width: 128px;" />
                           </a>
                     ...
                     <tr>
                        <td align="left" valign="top">
                           <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">
                              <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">Hallo Wedstrijd Admin,</span>
                           </font>
                           ...
                           <font face="'Source Sans Pro', sans-serif" color="#585858" style="font-size: 24px; line-height: 32px;">
                             ...
                             <h2> Er is weer een winnaar bekend van de Coca-Cola Happiness contest! </h2>
                            </span>
                           </font>
                                 ...
                                 <tr>
                                    ...
                                    <td class="mob_center" align="left" valign="top">
                                       ...
                                       <font face="'Source Sans Pro', sans-serif" color="#000000" style="font-size: 19px; line-height: 23px; font-weight: 600;">
                                          <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 19px; line-height: 23px; font-weight: 600;">Coca Cola</span>
                                       </font>
                                       ...
                                       <font face="'Source Sans Pro', sans-serif" color="#7f7f7f" style="font-size: 19px; line-height: 23px;">
                                          <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #7f7f7f; font-size: 19px; line-height: 23px;">Share the Happiness contest</span>
                                       </font>
                                    </td>
                                    <td width="18" style="width: 18px; max-width: 18px; min-width: 18px;">&nbsp;</td>
                                 </tr>
                                 ...
                                 <tr>
                                    <td align="center" valign="top">
                                       ...
                                       <div style="display: block; max-width: 177px;">
                                          <img src="svg/cocaColahome.svg" alt="img" width="177" border="0" style="display: block; width: 177px; max-width: 100%;" />
                                       </div>
                                    </td>
                                 </tr>
                              </table>
